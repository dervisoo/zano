...
namespace nodetool
{
  ...
  bool node_server<t_payload_net_handler>::init(const boost::program_options::variables_map& vm)
  {
    ...
    ADD_HARDCODED_SEED_NODE("15.204.9.173", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("24.144.90.40", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("24.199.109.184", P2P_DEFAULT_PORT);
